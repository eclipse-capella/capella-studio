...
public class SectionJavaClass
	...
	protected final String TEXT_4 = "import org.polarsys.capella.core.ui.properties.sections.AbstractSection;"
			+ NL;
	protected final String TEXT_5 = "import java.util.ArrayList;"
			+ NL
	...
	protected final String TEXT_21 = "]</b></em>'." + NL
	...
	protected final String TEXT_32 = NL + "\t\t* <!-- begin-model-doc -->" + NL
			+ "\t\t* <!-- end-model-doc -->";
	protected final String TEXT_33 = NL + "\t\t* <!-- begin-user-doc -->" + NL
	...
	protected final String TEXT_45 = NL + "\t\t* <!-- begin-model-doc -->" + NL
			+ "\t\t* <!-- end-model-doc -->";
	protected final String TEXT_46 = NL + " \t\t* <!-- begin-user-doc -->" + NL
			+ " \t\t* <!-- end-user-doc -->" + NL + " \t\t* @generated" + NL
			+ " \t\t*/" + NL + "\t\tprivate Group ";
	...
	protected final String TEXT_50 = NL + "\t/**" + NL
			...
			+ NL + "\t* @param eObject: current object" + NL + "\t* @generated"
			+ NL + "\t*/" + NL + "\tpublic boolean select(Object eObject) {"
			+ NL + "\t\tEObject eObjectToTest = super.selection(eObject);" + NL
			+ "\t\t";
	protected final String TEXT_51 = NL + "\t\t";
	protected final String TEXT_52 = NL + "\t\t\tif (";
	protected final String TEXT_53 = ")" + NL + "\t\t\t\treturn true;" + NL
			+ "\t\t\t\t";
	protected final String TEXT_54 = NL + "\t\t\telse" + NL + "\t\t\t{" + NL
			+ "\t\t\t\tEObject children = get";
	protected final String TEXT_55 = "Object(eObjectToTest);" + NL
			+ "\t\t\t\tif (children != null)" + NL + "\t\t\t\t\treturn true;"
			+ NL + "\t\t\t}" + NL + "\t\t\t";
	...
	protected final String TEXT_57 = "\t\t" + NL + "" + NL
			+ "\t\tif (newEObject != null && !(newEObject instanceof ";
	protected final String TEXT_58 = "))" + NL + "\t\t\tnewEObject = get";
	protected final String TEXT_59 = "Object(newEObject);" + NL;
	protected final String TEXT_60 = "\t\t\t" + NL
			+ "\t\tif (newEObject != null){" + NL
			+ "\t\t\tloadData((CapellaElement) newEObject);" + NL
			+ "\t\t}else{" + NL + "\t\t\treturn;" + NL + "\t\t}" + NL + "\t}\t"
			+ NL;
	...
	protected final String TEXT_62 = "Object(EObject parent){"
			...
			+ "\t\tEObject result = null;" + NL
			+ "\t\tfor (EObject iEObject : parent.eContents()) " + NL + "\t\t{"
			+ NL + "\t\t\tif (iEObject instanceof ";
	protected final String TEXT_63 = ")" + NL + "\t\t\t{" + NL
			+ "\t\t\t\tresult = (result == null ? (";
	protected final String TEXT_64 = ")iEObject : null );"
			+ NL
	...
	protected final String TEXT_78 = " = getWidgetFactory().createGroup(";
	protected final String TEXT_79 = ", ";
	protected final String TEXT_80 = ");" + NL + "\t\t\t";
	protected final String TEXT_81 = ".setLayout(new GridLayout(";
	protected final String TEXT_82 = ", false));" + NL + "\t\t\tGridData gd";
	protected final String TEXT_83 = " = new GridData(GridData.FILL_HORIZONTAL);"
			+ NL + "\t\t\tgd";
	protected final String TEXT_84 = ".horizontalSpan = ((GridLayout)";
	protected final String TEXT_85 = ".getLayout()).numColumns;" + NL
			+ "\t\t\t";
	protected final String TEXT_86 = ".setLayoutData(gd";
	...
	protected final String TEXT_100 = " = new SimpleSemanticField(";
	...
	protected final String TEXT_113 = ".loadData(capellaElement_p, " + NL
			+ "\t\t\t\t\t\t\t\t\t";
	protected final String TEXT_114 = ");\t" + NL + "\t\t\t  \t";
	protected final String TEXT_115 = NL + "\t\t\t";
	protected final String TEXT_116 = ".loadData(capellaElement_p);\t\t\t" + NL
			+ "\t\t\t  \t";
	protected final String TEXT_117 = NL + "\t";
	protected final String TEXT_118 = NL + "\t";
	protected final String TEXT_119 = NL + "\t\tabstractSemanticFields.add(";
	protected final String TEXT_120 = ");" + NL + "\t";
	protected final String TEXT_121 = NL + "\t";
	protected final String TEXT_122 = NL;
	protected final String TEXT_123 = NL + NL + "\t/**" + NL
			+ "\t* <!-- begin-user-doc -->" + NL + "\t* <!-- end-user-doc -->"
			+ NL + "\t* @param capellaElement_p" + NL + "\t* @generated" + NL
			+ "\t*/" + NL
			+ "\tpublic void loadData(CapellaElement capellaElement_p) {" + NL
	...
	protected final String TEXT_124 = NL
			...
			+ NL + "\t\t";
	protected final String TEXT_125 = NL + "\t\treturn abstractSemanticFields;"
			+ NL + "\t}" + NL + "\t";
	...
	protected void method_javaBlockEnd(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {

		stringBuffer.append(TEXT_1);
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "javaBlockEnd",
	...
	protected void method_setParameters(final StringBuffer stringBuffer,
		...
		classname = JDTUtility.getValidClassName(tabID + "_"
				+ parameter.getName());
	...
	protected void method_setSectionClassToExtend(
		...
		new Node.DataLeaf(ictx.getNode(), getClass(),
				"setSectionClassToExtend", stringBuffer.toString());
	}

	protected void method_setInterfaceToImplement(
			final StringBuffer stringBuffer, final PatternContext ctx)
			throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(),
				"setInterfaceToImplement", stringBuffer.toString());
	}

	protected void method_genPackageName(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "genPackageName",
				stringBuffer.toString());
	}

	protected void method_genSectionSuperClassesImport(
			final StringBuffer stringBuffer, final PatternContext ctx)
			throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(),
				"genSectionSuperClassesImport", stringBuffer.toString());
	}

	protected void method_gentDefaultImports(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {

		stringBuffer.append(TEXT_5);
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "gentDefaultImports",
				stringBuffer.toString());
	}

	protected void method_genWidgetDependentImports(
			final StringBuffer stringBuffer, final PatternContext ctx)
			throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(),
				"genWidgetDependentImports", stringBuffer.toString());
	}

	protected void method_genModelDependentImports(
			final StringBuffer stringBuffer, final PatternContext ctx)
			throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(),
				"genModelDependentImports", stringBuffer.toString());
	}

	protected void method_genJavaClassComment(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "genJavaClassComment",
				stringBuffer.toString());
	}

	protected void method_genJavaClassDeclaration(
			final StringBuffer stringBuffer, final PatternContext ctx)
			throws Exception {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(),
				"genJavaClassDeclaration", stringBuffer.toString());
	}

	protected void method_genWidgetDeclaration(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {
		...
		class widgetPropertyGenerator {
			...
			private void generateWidgets(UIContainer uiContainer) {
				...
				if (uiContainer.getSubContainers() != null
						&& uiContainer.getSubContainers().size() > 0) {
					for (UIContainer iUIContainer : uiContainer
							.getSubContainers()) {
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "genWidgetDeclaration",
				stringBuffer.toString());
	}

	protected void method_genFilterMethod(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {
		...
		class WidgetSelectGenerator {
			...
			private void createSelectList(UIContainer container) {
				...
				for (UIField uiField : container.getUI_fields()) {
					...
					String className = ((NamedElement) uiField.getMapping()
							.getUI_Field_Mapped_To().eContainer()).getName();
			...
			private void generateSelect(UIContainer container) {
				...
				if (result.trim().length() != 0) {
					...
					if (UISectionUtility
							.canGenerateSelectionForContainer(parameter)
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "genFilterMethod",
				stringBuffer.toString());
	}

	protected void method_genView(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {
		...
		class widgetCreationGenerator {
			private int getParentColumns(UIContainer container) {
				int result = 1;
				for (UIField uiField : container.getUI_fields())
					if (uiField.getType().equals(
							UI_Field_Type.SIMPLE_CHOICE_LIST)
							|| uiField.getType().equals(
									UI_Field_Type.MULTIPLE_CHOICE_LIST)) {
						result = 6;
						break;
					}
				return result;
			...
			private void generateGroups(UIContainer container) {
				...
				if (!(container.eContainer() instanceof UI)) {
					...
					String groupLabel = (container.getLabel() != null
							&& container.getLabel().trim().length() > 0 ? "\""
							+ container.getLabel() + "\""
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "genView",
				stringBuffer.toString());
	}

	protected void method_genController(final StringBuffer stringBuffer,
			final PatternContext ctx) throws Exception {
		...
		class widgetPropertyGenerator {
			...
			private void generateLoadData(UIContainer container) {
				...
				for (UIField uiField : container.getUI_fields()) {
					String widgetName = epfUtility.getWidgetName(uiField);
					String widgetFieldAccessorName = epfUtility
							.getWidgetAccessor(uiField);
					switch (uiField.getType()) {
					case TEXT:
					case TEXTAREA:
					case MULTIPLE_CHOICE_LIST:
		...
		InternalPatternContext ictx = (InternalPatternContext) ctx;
		new Node.DataLeaf(ictx.getNode(), getClass(), "genController",
				stringBuffer.toString());
	}
