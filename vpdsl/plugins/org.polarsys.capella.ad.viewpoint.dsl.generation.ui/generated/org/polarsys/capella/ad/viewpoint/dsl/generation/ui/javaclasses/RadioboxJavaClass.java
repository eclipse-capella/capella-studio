...
public class RadioboxJavaClass
	...
	protected final String TEXT_4 = "]</b></em>' customized RadioboxGroup field. "
			+ NL
			+ " * <!-- end-user-doc -->"
			+ NL
			+ " * <p>"
	...
	protected final String TEXT_8 = NL + NL + "  /**" + NL
			...
			+ "   */" + NL + "  public ";
	protected final String TEXT_9 = "(Composite parent_p, TabbedPropertySheetWidgetFactory widgetFactory_p) {"
	...
	protected final String TEXT_17 = NL + "    return fields;" + NL + "  }"
			+ NL + "" + NL + "   /**" + NL + "   * <!-- begin-user-doc -->"
			+ NL + "   * <!-- end-user-doc -->" + NL + "   * {@inheritDoc}"
			+ NL + "   * @generated   " + NL + "   */" + NL + "  @Override"
			+ NL + "  public Button getDefaultSemanticField() {";
	...
	protected void method_genSematicImports(final StringBuffer stringBuffer,
		...
		stringBuffer
				.append(dataWidget.widgetFieldTypeEnumerator.enumImportName);
