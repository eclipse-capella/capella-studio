...
public class CheckboxJavaClass
	...
	protected final String TEXT_4 = "]</b></em>' customized CheckboxGroup field. "
			+ NL
			+ " * <!-- end-user-doc -->"
			+ NL
			+ " * <p>"
			...
			+ NL
			+ "public class ";
	protected final String TEXT_5 = " extends AbstractSemanticCheckboxGroup {"
			+ NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL
			+ "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL
			+ "\t */" + NL + "  private Button ";
	protected final String TEXT_6 = ";" + NL + "" + NL + "  /**" + NL
			+ "   * Constructor." + NL + "   * <!-- begin-user-doc -->" + NL
			+ "   * <!-- end-user-doc -->" + NL + "   * @param parent_p" + NL
			+ "   * @param widgetFactory_p" + NL + "   * @generated" + NL
			+ "   */" + NL + "  public ";
	protected final String TEXT_7 = "(Composite parent_p, TabbedPropertySheetWidgetFactory widgetFactory_p) {"
			+ NL + "    super(parent_p, widgetFactory_p);";
	protected final String TEXT_8 = NL + "    ";
	protected final String TEXT_9 = " = createButton(";
	protected final String TEXT_10 = ", ";
	protected final String TEXT_11 = ", parent_p); //$NON-NLS-1$ "
			+ NL
			...
			+ NL + "\t\tGridData gd = new GridData(GridData.FILL_HORIZONTAL);"
			+ NL
			+ "\t\tgd.horizontalSpan = ((GridLayout)parentLayout).numColumns;"
			+ NL + "\t\t";
	protected final String TEXT_12 = ".setLayoutData(gd);" + NL + "\t}" + NL
			+ "  }" + NL + "" + NL + "  /**" + NL
			+ "   * <!-- begin-user-doc -->" + NL
			+ "   * <!-- end-user-doc -->" + NL + "   * {@inheritDoc}" + NL
			+ "   * @generated   " + NL + "   */" + NL + "  @Override" + NL
			+ "  public List<Button> getSemanticFields() {" + NL
			+ "    List<Button> fields = new ArrayList<Button>();" + NL
			+ "    fields.add(";
	protected final String TEXT_13 = ");" + NL + "    return fields;" + NL
			+ "  }" + NL + "}";
