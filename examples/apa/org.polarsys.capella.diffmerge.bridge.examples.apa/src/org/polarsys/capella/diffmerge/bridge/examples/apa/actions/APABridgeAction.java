 ...
 **********************************************************************/
package org.polarsys.capella.diffmerge.bridge.examples.apa.actions;
...
import org.polarsys.capella.diffmerge.bridge.examples.apa.APAExampleActivator;
import org.polarsys.capella.diffmerge.bridge.examples.apa.Messages;
import org.polarsys.capella.diffmerge.bridge.examples.apa.operations.APABridgeJob;
 ...
 */
public class APABridgeAction implements IObjectActionDelegate {
  ...
  public void run(IAction action_p) {
    ...
    if (context != null) {
      new APABridgeJob(context).schedule();
    } else {
      MessageDialog.openError(
          _workbenchPart.getSite().getShell(),
          APAExampleActivator.getDefault().getLabel(),
          Messages.APABridgeAction_IncorrectSelection);
    }
  }
