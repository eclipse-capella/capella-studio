...
public class CapellaExtensionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CapellaExtensionPackage.CAPELLA_EMF_GENERATION: {
				CapellaEmfGeneration capellaEmfGeneration = (CapellaEmfGeneration)theEObject;
				T result = caseCapellaEmfGeneration(capellaEmfGeneration);
				if (result == null) result = caseEmdeGeneration(capellaEmfGeneration);
				if (result == null) result = caseEmfGeneration(capellaEmfGeneration);
				if (result == null) result = caseEcoreElement(capellaEmfGeneration);
				if (result == null) result = casePluginProvider(capellaEmfGeneration);
				if (result == null) result = caseGenerationElement(capellaEmfGeneration);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Capella Emf Generation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Capella Emf Generation</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Emde Generation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Emde Generation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
