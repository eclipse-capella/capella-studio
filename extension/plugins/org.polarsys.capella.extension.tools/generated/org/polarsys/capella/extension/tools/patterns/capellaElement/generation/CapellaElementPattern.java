...
public class CapellaElementPattern extends org.eclipse.egf.emf.pattern.model.call.Class.ClassgetGenFeatureTODOoverride {
	protected static String nl;

	public static synchronized CapellaElementPattern create(String lineSeparator) {
		nl = lineSeparator;
		CapellaElementPattern result = new CapellaElementPattern();
		nl = null;
		return result;
	}

	public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
	protected final String TEXT_1 = "//INJECTED-CODE-BEGIN" + NL + "\treturn new BasicEList<AbstractTrace>();" + NL
			+ "//INJECTED-CODE-END" + NL;
	protected final String TEXT_2 = NL;

	public CapellaElementPattern() {
